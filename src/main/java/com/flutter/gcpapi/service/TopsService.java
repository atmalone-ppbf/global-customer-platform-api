...
public class TopsService {
    ...
    private static final MapStateDescriptor<String, NicknamedAccount> TOPS_STATE_DESCRIPTOR =
            new MapStateDescriptor<>("topsState", Types.STRING, Types.POJO(NicknamedAccount.class));
    ...
    public Map<String,NicknamedAccount> queryTopsState(String key) throws Exception {
